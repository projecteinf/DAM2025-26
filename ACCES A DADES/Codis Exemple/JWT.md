...
// Nom fitxer: 24-JWT/ADO/Domain/Entitites/Product.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Domain/Validators/ProductValidator.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Program.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/API/EndPoints/User.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/API/EndPoints/Product.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Mappers/ProductManager.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/DTO/ProductResponse.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/DTO/ProductRequest.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Persistence/Entitites/ProductEntity.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Persistence/Repositories/ProductMSSQL.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Persistence/Repositories/Product/Interface/IQueryBuilderProduct.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Persistence/Repositories/Product/Interface/IProductRepo.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Persistence/Repositories/Product/Postgres/ProductPostgres.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Persistence/Repositories/QueryBuilderProductMSSQL.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Services/JsonWebToken/JwtTokenService.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Services/Database/Interfaces/IDatabase.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Services/Database/MSSQLConnection.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Services/Database/PostgresConnection.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Services/Database/Providers/DatabaseProvider.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Services/Extensions/Database/DatabaseServiceExtensions.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Common/Result.cs
```CSharp
...
// Nom fitxer: 24-JWT/ADO/Infraestructure/Extensions/ProductServicesExtensions.cs
```CSharp
