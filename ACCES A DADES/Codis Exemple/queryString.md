...
// Nom fitxer: 12-QueryString/ADO/Program.cs
```CSharp
...
// Nom fitxer: 12-QueryString/ADO/Repository/ProductADO.cs
```CSharp
...
class ProductADO
{
    ...
    public static List<Product> GetAll(DatabaseConnection dbConn,int start, int limit)
    {
        List<Product> products = new();

        dbConn.Open();
        string sql = $"SELECT Id, Code, Name, Price FROM Products Order By Name LIMIT {total} OFFSET {start}";
...
// Nom fitxer: 12-QueryString/ADO/EndPoints/Product.cs
```CSharp
...
public static class EndpointsProducts
{
    ...
    {
        // GET /products
        // http://localhost:5000/products?start=0&total=5
        
        app.MapGet("/products", (int start=0, int total=20) =>
        {
            Console.WriteLine($"TOTAL PRODUCTES {start} => {total}");
            List<Product>  products = ProductADO.GetAll(dbConn,start, total);
...
// Nom fitxer: 12-QueryString/ADO/DTO/ProductResponse.cs
```CSharp
...
// Nom fitxer: 12-QueryString/ADO/DTO/ProductRequest.cs
```CSharp
...
// Nom fitxer: 12-QueryString/ADO/Validators/ProductValidator.cs
```CSharp
...
// Nom fitxer: 12-QueryString/ADO/Model/Product.cs
```CSharp
...
// Nom fitxer: 12-QueryString/ADO/Services/DatabaseConnection.cs
```CSharp
...
// Nom fitxer: 12-QueryString/ADO/Common/Result.cs
```CSharp
