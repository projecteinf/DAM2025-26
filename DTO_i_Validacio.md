...
// Nom fitxer: 11-Validacio/ADO/Program.cs
```CSharp
...
// Nom fitxer: 11-Validacio/ADO/Repository/ProductADO.cs
```CSharp
...
// Nom fitxer: 11-Validacio/ADO/EndPoints/Product.cs
```CSharp
...
// Nom fitxer: 11-Validacio/ADO/DTO/ProductResponse.cs
```CSharp
...
// Nom fitxer: 11-Validacio/ADO/DTO/ProductRequest.cs
```CSharp
...
// Nom fitxer: 11-Validacio/ADO/Validators/ProductValidator.cs
```CSharp
...
// Nom fitxer: 11-Validacio/ADO/Model/Product.cs
```CSharp
...
// Nom fitxer: 11-Validacio/ADO/Services/DatabaseConnection.cs
```CSharp
...
// Nom fitxer: 11-Validacio/ADO/Common/Result.cs
```CSharp
